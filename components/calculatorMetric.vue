<template>
<div>
  <form class="formborder bg-opacity-20 bg-clip-padding flex flex-col p-10 rounded-md" style="backdrop-filter:blur(20px)" @submit.prevent="calculate">
    <div class="flex flex-row justify-center p-2">
      <input type="radio" class="genderclass" name="gender" id="male" value="MALE" v-model="gender" />
      <label for="male" class="hover:bg-blue-900 flex h-12 justify-center w-1/3 border items-center text-center rounded-md border-2px border-white text-white font-black"
      >MALE</label>
      <input type="radio" class="genderclass" name="gender" id="female" value="FEMALE" v-model="gender"
      />
      <label for="female" class="hover:bg-blue-900 flex h-12 justify-center w-1/3 border items-center text-center rounded-md border-2px border-white text-white font-black">FEMALE</label>
    </div>
    ...
    <div class="flex flex-row pt-4 px-6">
      <label class="weight text-white mr-2" for="weight">WEIGHT (kg)</label>
      <input
        type="number"
        ...
        v-model="weight"
      />
      <label class="height text-white mr-2" for="height">HEIGHT (cm)</label>
      <input
        type="number"
        class="w-full focus:outline-none mr-2"
        name="height"
